...
public class ChangePasswordFrame3 extends JFrame 
{
    JLabel Lable1;
    JLabel pass;
    ...
    public ChangePasswordFrame3()
    {
        super("Manager Change Password");
        ...
        ActionListener a1 = new ActionListener()
        {
              ...
              {
                dispose();
                ManagerFrame c1 = new ManagerFrame();
