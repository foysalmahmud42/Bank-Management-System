...
public class ChangePasswordFrame4 extends JFrame 
{
    JLabel Lable1;
    JLabel pass;
    ...
    public ChangePasswordFrame4()
    {
        super("Employee Change Password");
        ...
        ActionListener a1 = new ActionListener()
        {
              ...
              {
                dispose();
                EmployeeFrame c1 = new EmployeeFrame();
