...
public class ManagerFrame extends JFrame
{
    ...
    void addContentCF()
    {
        ...
        JMenu jMenuEmployee = new JMenu("Employee");
        ...
        JMenuItem jmE1 = new JMenuItem("Add");
        JMenuItem jmE2 = new JMenuItem("Remove");
                
        jMenuOption.add(jmI1);
        jMenuOption.add(jmI2);
        jMenucustomer.add(jmC1);
        jMenucustomer.add(jmC2);
        jMenuEmployee.add(jmE1);
        jMenuEmployee.add(jmE2);
        ...
        ActionListener a2 = new ActionListener()
        {
            ...
            {
                dispose();
                ChangePasswordFrame3 m1 = new ChangePasswordFrame3();
       ...
       ActionListener a3 = new ActionListener()
        {
            ...
            {
                dispose();
                CustomerRemoveFrame c1 = new CustomerRemoveFrame();
       ...
       ActionListener a6 = new ActionListener()
        {
            ...
            {
                dispose();
                EmployeeRemoveFrame e1 = new EmployeeRemoveFrame ();
                e1.setResizable(false); 
                e1.setVisible(true);
            }
        };
       jmE1.addActionListener(a6);
